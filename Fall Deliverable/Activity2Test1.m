...
for k = 1 : nFrames
    ...
    frameBW = bwareaopen(framegray, 600);
    I2 = imdilate(frameBW,squareElem);
    I3 = imdilate(I2, squareElem);
    framegray = im2bw(I2, .5);
    bwgray = bwareaopen(framegray, 100);
    Ibwopen = imopen(framegray, squareElem);
    hBlob = vision.BlobAnalysis('MinimumBlobArea',5500,'MaximumBlobArea',10000);
