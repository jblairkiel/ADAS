%% detectLines
% detect lines for various worms of various lengths and orientations using
% the hough transform
...
% Note: Morphological operations like skeletonization is covered in the 
% next section
